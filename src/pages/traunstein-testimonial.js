...
import TraunsteinVideo from "src/components/Common/TraunsteinVideo"
...
const ShopperFlowAnalytics = () => {
    ...
    return (
        <>
            ...
            <Head>
                <title>
                Case Study - Traunstein City Visitor Flow Project | Footfall Counter | People Counting Software
                </title>
                <meta name='description' content='Case Study - Traunstein Testimonial' />
                <meta property="og:title" content="Case Study- Traunstein Testimonial" />
                <meta property="og:description" content="Case Study- Traunstein Testimonial" />
                <meta property="og:image" content="https://www.ariadne.inc/images/blog-image/shopper-flow.png"/>
                <link rel='icon' href='/favicon.png' />
            </Head>
            <NextSeo canonical='https://www.ariadne.inc/traunstein-testimonial' />
                        ...
                        <div className="">
                            <div className="blog-details-desc">
                                ...
                                <div className="article-content">
                                    ...
                                    <h1 className="fs-1 lh-base pt-5" style={{fontFamily:"GothamBlack"}}>Case Study - Traunstein (Stadt) | Ariadne</h1>
