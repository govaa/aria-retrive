...
import CustomerFlowVideo from "src/components/Common/CustomerFlowVideo"
 
const CustomerFlowAnalytics = () => {
    ...
    return (
        <>
            ...
            <Head>
                ...
                <meta name='description' content='Ariadne: Customer Flow Analytics' />
                <meta property="og:title" content="Ariadne: Customer Flow Analytics" />
                <meta property="og:description" content="Ariadne: Customer Flow Analytics" />
                <meta property="og:image" content="https://www.ariadne.inc/images/blog-image/shopper-flow.png"/>
                <link rel='icon' href='/favicon.png' />
            </Head>
            <NextSeo canonical='https://www.ariadne.inc/customer-flow-analytics' />
                        ...
                        <div className="">
                            <div className="blog-details-desc">
                                ...
                                <div className="article-content">
                                    ...
                                    <h1 className="fs-1 lh-base pt-5" style={{fontFamily:"GothamBlack"}}>Ariadne: Die ultimative Lösung für die Kundenströme</h1>
...
export default CustomerFlowAnalytics;
