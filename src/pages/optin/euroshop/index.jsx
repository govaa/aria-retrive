...
const EuroShop2023OptIn = () => {
  ...
  return (
    <>
      <Head>
        <title>Welcome to EuroShop 2023 | Ariadne</title>
        <meta name='description' content='Ariadne' />
        <link rel='icon' href='/favicon.png' />
      </Head>
      <NextSeo canonical='https://www.ariadne.inc/optin/euroshop2023' />

      <PageBanner pageTitle='Welcome to Ariadne Booth!' />
...
export default EuroShop2023OptIn;
