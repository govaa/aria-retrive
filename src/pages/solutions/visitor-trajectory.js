...
const VisitorTrajectory = () => {
    return (
        <>

            <Head>
                <title>
                Visitor Trajectory | People Counter | People Counting Software
                </title>
                <meta name='description' content='Ariadne' />
                <link rel='icon' href='/favicon.png' />
            </Head>
            <NextSeo canonical='https://www.ariadne.inc/solutions/visitor-trajectory' />
...
export default VisitorTrajectory;