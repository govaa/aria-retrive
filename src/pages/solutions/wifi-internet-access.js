...
const WifiInternetAccess = () => {
    return (
        <>

            <Head>
                <title>
                WiFi Internet Access | People Counter | People Counting Software
                </title>
                <meta name='description' content='Ariadne' />
                <link rel='icon' href='/favicon.png' />
            </Head>
            <NextSeo canonical='https://www.ariadne.inc/solutions/wifi-internet-access' />
...
export default WifiInternetAccess;