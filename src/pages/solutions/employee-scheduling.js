...
export async function getStaticProps({ locale }) {
    return {
      props: {
        ...(await serverSideTranslations(locale, ["pages/solutions/employee-scheduling"])),
      },
    };
  }
...
const EmployeeScheduling = () => {
    ...
    const { t } = useTranslation("pages/solutions/employee-scheduling");
    ...
    return (
        <>
            ...
            <NextSeo canonical='https://www.ariadne.inc/solutions/employee-scheduling' />
                ...
                <div className="container">
                    <div className="row align-items-center">
                        <div className="col-lg-6 services-details">
                            ...
                            <p>{t("text-4")}<strong>{t("text-5")}</strong>.</p>
                        ...
                        <div className="col-lg-6 services-details-image">
                            <img 
                                src="/images/services-details-image/scheduler.png" 
                    ...
                    <div className="row align-items-center">
                        ...
                        <div className="col-lg-6 services-details">
                            <div className="services-details-desc">
                                ...
                                <p>{t("text-6")}<a href="/solutions/people-counting/"><u>{t("text-7")}</u></a>{t("text-8")}</p>

                                <p>{t("text-9")}<strong>{t("text-10")}</strong>{t("text-11")}</p>
