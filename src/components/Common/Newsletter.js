                ...
                <div className="row align-items-center">
                    ...
                    <div className="col-lg-6 col-md-12">
                        <div className="free-trial-content">
                            ...
                            {state==="SUCCESS" && (
                                <p className="domain-search-content text-success">Thank you for your interest, your credentials and the dashboard access link will be sent shortly!</p>
                            )}
                            <p>Test out Ariadne features for your business.</p>
                        </div>
                    </div>
                </div>
            </div>
