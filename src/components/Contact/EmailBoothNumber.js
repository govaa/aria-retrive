                            ...
                            <div className="row gy-2">
                                ...
                                <div className="col-lg-12 col-md-12">
                                    ...
                                    <div className="form-check">
                                        ...
                                        By proceeding, you consent to our <Link href="/tou-demo"><a>Terms</a></Link> and <Link href="/privacy-policy"><a>Privacy policy</a></Link>.
                                        </label>
                                        {isSent && <div className="pt-4 pb-4 text-success">Your request has been received, your booth will be added to the exhibitor list to measure booth success.</div>}
                                    </div>
                                </div>
