...
const ContactForm = () => { 
    ...
    return (
        <div className="contact-area pt-4 justify-content-center align-items-center">
                            ...
                            <div className="row gy-2 pb-80">
                                ...
                                <div className="col-lg-12 col-md-12">
                                    ...
                                    <div className="form-check">
                                        ...
                                        {isSent && <div className="pt-4 pb-4 text-success">Your request has been received, your invitation link will be sent via email.</div>}
                                    </div>
                                </div>
